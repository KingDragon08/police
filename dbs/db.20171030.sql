...
CREATE TABLE `task` (
  ...
  `rejectInfo` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
INSERT INTO `task` VALUES (2,'cameraName','cameraLocation','taskDescription',1,'1509080264537',1,2,NULL),(3,'cameraName','cameraLocation','taskDescription',1,'1509264493188',0,3,NULL),(4,'cameraName','cameraLocation','taskDescription',1,'1509266954334',0,1,NULL);
...
-- Dump completed on 2017-10-30 16:07:53
